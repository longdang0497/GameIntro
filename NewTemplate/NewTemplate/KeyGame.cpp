...
void CKeyGame::update()
{
	...
	keyChangeGameMode = key->IsKeyDown(DIK_Q);
	keyChangeGameModePress = keyChangeGameMode && !isKeyChangeGameModeDownPrevious;
	isKeyChangeGameModeDownPrevious = keyChangeGameMode;
